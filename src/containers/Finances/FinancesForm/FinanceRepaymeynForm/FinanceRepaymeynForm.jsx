   ...
   return (
      <>
         <div className="izma__lidlar__form-bolim">
            <Form className="izma__lidlar__form-bolim-form" style={{ width: 400 }}>
               ...
               <div className="form_group izma__lidlar__form-bolim-form-center" style={{ width: "100%" }}>
                  ...
                  <Input className={"section_name_input"} type='number' name={"nomi"} />
               </div>
            </Form>
            <button onClick={onCloseS} className="izma__lidlar__form-bolim-form-button">
               Yarating
            </button>
         </div>
      </>
